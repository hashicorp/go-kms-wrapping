...
type Options struct {
	...
	// WithNoHmac specifies that an HMAC is not necessary for the mechanism, even if marked as "required"
	WithNoHmac bool `protobuf:"varint,100,opt,name=with_no_hmac,json=withNoHmac,proto3" json:"with_no_hmac,omitempty"`
}
...
func (x *Options) GetWithNoHmac() bool {
	if x != nil {
		return x.WithNoHmac
	}
	return false
...
var file_github_com_hashicorp_go_kms_wrapping_v2_types_proto_rawDesc = []byte{
	...
	0x6e, 0x63, 0x6f, 0x64, 0x69, 0x6e, 0x67, 0x22, 0xb7, 0x06, 0x0a, 0x07, 0x4f, 0x70, 0x74, 0x69,
	...
	0x73, 0x61, 0x6c, 0x6c, 0x6f, 0x77, 0x45, 0x6e, 0x76, 0x56, 0x61, 0x72, 0x73, 0x12, 0x20, 0x0a,
	0x0c, 0x77, 0x69, 0x74, 0x68, 0x5f, 0x6e, 0x6f, 0x5f, 0x68, 0x6d, 0x61, 0x63, 0x18, 0x64, 0x20,
	0x01, 0x28, 0x08, 0x52, 0x0a, 0x77, 0x69, 0x74, 0x68, 0x4e, 0x6f, 0x48, 0x6d, 0x61, 0x63, 0x1a,
