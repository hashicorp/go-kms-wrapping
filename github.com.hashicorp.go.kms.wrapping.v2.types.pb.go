...
type Options struct {
	...
	// The IV, if any
	WithIv []byte `protobuf:"bytes,21,opt,name=with_iv,json=withIv,proto3" json:"with_iv,omitempty"`
	...
	// The key does not need to exist at the time of init
	WithKeyNotRequired bool `protobuf:"varint,40,opt,name=with_key_not_required,json=withKeyNotRequired,proto3" json:"with_key_not_required,omitempty"`
}
...
func (x *Options) GetWithKeyNotRequired() bool {
	if x != nil {
		return x.WithKeyNotRequired
	}
	return false
}
...
var file_github_com_hashicorp_go_kms_wrapping_v2_types_proto_rawDesc = []byte{
	...
	0x52, 0x05, 0x66, 0x6c, 0x61, 0x67, 0x73, 0x22, 0xc5, 0x02, 0x0a, 0x07, 0x4f, 0x70, 0x74, 0x69,
	...
	0x0a, 0x07, 0x77, 0x69, 0x74, 0x68, 0x5f, 0x69, 0x76, 0x18, 0x15, 0x20, 0x01, 0x28, 0x0c, 0x52,
	...
	0x68, 0x43, 0x6f, 0x6e, 0x66, 0x69, 0x67, 0x4d, 0x61, 0x70, 0x12, 0x31, 0x0a, 0x15, 0x77, 0x69,
	0x74, 0x68, 0x5f, 0x6b, 0x65, 0x79, 0x5f, 0x6e, 0x6f, 0x74, 0x5f, 0x72, 0x65, 0x71, 0x75, 0x69,
	0x72, 0x65, 0x64, 0x18, 0x28, 0x20, 0x01, 0x28, 0x08, 0x52, 0x12, 0x77, 0x69, 0x74, 0x68, 0x4b,
	0x65, 0x79, 0x4e, 0x6f, 0x74, 0x52, 0x65, 0x71, 0x75, 0x69, 0x72, 0x65, 0x64, 0x1a, 0x40, 0x0a,
	...
	0x73, 0x68, 0x69, 0x63, 0x6f, 0x72, 0x70, 0x2f, 0x67, 0x6f, 0x2d, 0x6b, 0x6d, 0x73, 0x2d, 0x77,
	0x72, 0x61, 0x70, 0x70, 0x69, 0x6e, 0x67, 0x2f, 0x76, 0x32, 0x3b, 0x77, 0x72, 0x61, 0x70, 0x70,
