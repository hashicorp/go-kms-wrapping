...
// RSAEncryptionPadding defines the RSA encryption padding scheme and hash algorithm
type RSAEncryptionPadding int32

const (
	RSAEncryptionPadding_Unknown_RSAEncryptionPadding RSAEncryptionPadding = 0
	RSAEncryptionPadding_OaepSha1                     RSAEncryptionPadding = 1
	RSAEncryptionPadding_OaepSha256                   RSAEncryptionPadding = 2
	RSAEncryptionPadding_Pkcs1v15                     RSAEncryptionPadding = 3
)

// Enum value maps for RSAEncryptionPadding.
var (
	RSAEncryptionPadding_name = map[int32]string{
		0: "Unknown_RSAEncryptionPadding",
		1: "OaepSha1",
		2: "OaepSha256",
		3: "Pkcs1v15",
	}
	RSAEncryptionPadding_value = map[string]int32{
		"Unknown_RSAEncryptionPadding": 0,
		"OaepSha1":                     1,
		"OaepSha256":                   2,
		"Pkcs1v15":                     3,
	}
...
func (x RSAEncryptionPadding) Enum() *RSAEncryptionPadding {
	p := new(RSAEncryptionPadding)
	*p = x
	return p
}

func (x RSAEncryptionPadding) String() string {
	return protoimpl.X.EnumStringOf(x.Descriptor(), protoreflect.EnumNumber(x))
}

func (RSAEncryptionPadding) Descriptor() protoreflect.EnumDescriptor {
	return file_github_com_hashicorp_go_kms_wrapping_v2_types_proto_enumTypes[4].Descriptor()
}

func (RSAEncryptionPadding) Type() protoreflect.EnumType {
	return &file_github_com_hashicorp_go_kms_wrapping_v2_types_proto_enumTypes[4]
}

func (x RSAEncryptionPadding) Number() protoreflect.EnumNumber {
	return protoreflect.EnumNumber(x)
}

// Deprecated: Use RSAEncryptionPadding.Descriptor instead.
func (RSAEncryptionPadding) EnumDescriptor() ([]byte, []int) {
...
type Options struct {
	...
	// WithRSAEncryptionPadding specifies the RSA encryption algorithm to use (optional)
	WithRsaEncryptionPadding RSAEncryptionPadding `protobuf:"varint,120,opt,name=with_rsa_encryption_padding,json=withRsaEncryptionPadding,proto3,enum=github.com.hashicorp.go.kms.wrapping.v2.types.RSAEncryptionPadding" json:"with_rsa_encryption_padding,omitempty"`
}
...
func (x *Options) GetWithoutEnvelope() bool {
	if x != nil {
...
func (x *Options) GetWithRsaEncryptionPadding() RSAEncryptionPadding {
	if x != nil {
		return x.WithRsaEncryptionPadding
	}
	return RSAEncryptionPadding_Unknown_RSAEncryptionPadding
}
...
var file_github_com_hashicorp_go_kms_wrapping_v2_types_proto_rawDesc = []byte{
	...
	0x6e, 0x63, 0x6f, 0x64, 0x69, 0x6e, 0x67, 0x22, 0xe8, 0x07, 0x0a, 0x07, 0x4f, 0x70, 0x74, 0x69,
	...
	0x6f, 0x75, 0x74, 0x45, 0x6e, 0x76, 0x65, 0x6c, 0x6f, 0x70, 0x65, 0x12, 0x82, 0x01, 0x0a, 0x1b,
	0x77, 0x69, 0x74, 0x68, 0x5f, 0x72, 0x73, 0x61, 0x5f, 0x65, 0x6e, 0x63, 0x72, 0x79, 0x70, 0x74,
	0x69, 0x6f, 0x6e, 0x5f, 0x70, 0x61, 0x64, 0x64, 0x69, 0x6e, 0x67, 0x18, 0x78, 0x20, 0x01, 0x28,
	0x0e, 0x32, 0x43, 0x2e, 0x67, 0x69, 0x74, 0x68, 0x75, 0x62, 0x2e, 0x63, 0x6f, 0x6d, 0x2e, 0x68,
	...
	0x73, 0x2e, 0x52, 0x53, 0x41, 0x45, 0x6e, 0x63, 0x72, 0x79, 0x70, 0x74, 0x69, 0x6f, 0x6e, 0x50,
	0x61, 0x64, 0x64, 0x69, 0x6e, 0x67, 0x52, 0x18, 0x77, 0x69, 0x74, 0x68, 0x52, 0x73, 0x61, 0x45,
	0x6e, 0x63, 0x72, 0x79, 0x70, 0x74, 0x69, 0x6f, 0x6e, 0x50, 0x61, 0x64, 0x64, 0x69, 0x6e, 0x67,
	...
	,
...
var file_github_com_hashicorp_go_kms_wrapping_v2_types_proto_goTypes = []interface{}{
	...
	(RSAEncryptionPadding)(0), // 4: github.com.hashicorp.go.kms.wrapping.v2.types.RSAEncryptionPadding
...
var file_github_com_hashicorp_go_kms_wrapping_v2_types_proto_depIdxs = []int32{
	...
	4,  // 12: github.com.hashicorp.go.kms.wrapping.v2.types.Options.with_rsa_encryption_padding:type_name -> github.com.hashicorp.go.kms.wrapping.v2.types.RSAEncryptionPadding
